# Powerlevel10k configuration placeholder
# Replace with content generated by `p10k configure`
# Save as .p10k.zsh in this directory.
# Generated by Powerlevel10k configuration wizard on 2026-07-23 at 13:48 EDT.
# Based on romkatv/powerlevel10k/config/p10k-lean.zsh, checksum 37983.
# Wizard options: nerdfont-v3 + powerline, small icons, ascii, lean, 2 lines, dotted,
# lightest-ornaments, sparse, concise, transient_prompt, instant_prompt=verbose.
